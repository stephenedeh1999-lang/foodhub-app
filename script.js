...
const menuItems = [
    ...
    { 
        ...
        price: 12.99, 
        emoji: '🍛', 
        description: 'West Africa\'s signature one-pot rice dish with chicken',
    ...
    { 
        ...
        price: 13.99, 
        emoji: '🍲', 
        description: 'Smooth cassava-based semolina with egusi soup',
    ...
    { 
        ...
        price: 11.99, 
        emoji: '🍚', 
        description: 'Colorful Nigerian fried rice with vegetables',
        image: 'https://upload.wikimedia.org/wikipedia/commons/thumb/6/6b/Jollof_rice_with_grilled_chicken.jpg/640px-Jollof_rice_with_grilled_chicken.jpg'
    },
    { 
        id: 12, 
